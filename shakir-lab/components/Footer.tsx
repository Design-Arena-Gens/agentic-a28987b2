    ...
    <footer className="bg-gray-900 text-white py-12">
      <div className="container mx-auto px-4">
        <div className="grid md:grid-cols-4 gap-8">
          {/* About Section */}
          <div>
            <h3 className="text-lg font-bold mb-4 text-primary">Shakir Clinical Laboratory</h3>
            <p className="text-gray-400 text-sm">
              Providing advanced medical testing services with accuracy, reliability, and care.
            </p>
          </div>
          ...
          <div>
            ...
            <ul className="space-y-2 text-sm">
              ...
              <li><Link href="/reports" className="text-gray-400 hover:text-primary transition">Online Reports</Link></li>
            </ul>
          </div>
        ...
        <div className="border-t border-gray-800 mt-8 pt-6 text-center text-sm text-gray-400">
          <p>&copy; {new Date().getFullYear()} Shakir Clinical Laboratory. All rights reserved.</p>
        </div>
      </div>
    </footer>
  );
